  ...
  if (req.method === 'POST' && req.url === '/api/onboarding/new-client') {
    try {
      ...
      const steps = {
        ...
        discord_channel_created:     pendingStep({ autoDetected: false, owner: 'accountManager', priority: 1, dependsOn: ['client_joined_discord'], note: 'Create private Discord channel for client' }),
        ghl_subaccount_configured:   pendingStep({ autoDetected: false, owner: 'accountManager', priority: 2, dependsOn: ['onboarding_form_submitted'] }),
